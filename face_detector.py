...
for ix in txtfiles:
    ...
    facecascade = cv2.CascadeClassifier(
        'C:\\Users\\Mohamed Amine Guedri\\AppData\\Local\\Programs\\Python\\Python36\\Lib\\site-packages\\cv2\data\\haarcascade_frontalface_default.xml')
    eye_cascade = cv2.CascadeClassifier('C:\\Users\\Mohamed Amine Guedri\\AppData\\Local\\Programs\\Python\\Python36\\Lib\\site-packages\\cv2\data\\haarcascade_eye.xml')

    faces = facecascade.detectMultiScale(imgtest, scaleFactor=1.2, minNeighbors=5)

    print('Total numbernofnFaces found', len(faces))
